...
export default function StudentLoanCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCollateral(initialValues.collateral);
    setAppliedForLoan(initialValues.appliedForLoan);
    setLoanAmount(initialValues.loanAmount);
    setCurrency(initialValues.currency);
    setCollegeName(initialValues.collegeName);
    setGREScore(initialValues.GREScore);
    setGMATScore(initialValues.GMATScore);
    setErrors({});
  };
  const validations = {
    email: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new StudentLoan(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "StudentLoanCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
